...
public class ChangePaswordCommand extends Command {

  private final AuthSystem authSystem;

  public ChangePaswordCommand(AuthSystem authSystem) {
    super("changepassword", null, "changepass", "changepasswd", "chpass");
