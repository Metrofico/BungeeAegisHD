...
public class BungeeScheduler implements TaskScheduler {
  ...
  private final TIntObjectMap<BungeeTask> tasks = TCollections
      .synchronizedMap(new TIntObjectHashMap<BungeeTask>());
  ...
  public ScheduledTask schedule(Plugin owner, Runnable task, long delay, long period,
    ...
    BungeeTask prepared = new BungeeTask(this, taskCounter.getAndIncrement(), owner, task, delay,
        period, unit);
