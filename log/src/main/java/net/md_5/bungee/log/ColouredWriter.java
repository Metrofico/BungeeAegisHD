    ...
    private static final ReplacementSpecification[] REPLACEMENTS = new ReplacementSpecification[]
        {
            ...
            compile(ChatColor.STRIKETHROUGH,
