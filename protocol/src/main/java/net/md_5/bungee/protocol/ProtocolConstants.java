...
public class ProtocolConstants
{
    ...
    public static final List<Integer> SUPPORTED_VERSION_IDS_BF = Arrays.asList(
    ...
    public static final boolean isBeforeOrEq(final int before, final int other) {
        return before <= other;
    }

    public static final boolean isAfterOrEq(final int after, final int other) {
        return after >= other;
    }
