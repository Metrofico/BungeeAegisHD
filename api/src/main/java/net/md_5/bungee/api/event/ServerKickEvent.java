...
public class ServerKickEvent extends Event implements Cancellable {
    ...
    /**
     * The server the player was kicked from, should be used in preference to {@link
    ...
    public ServerKickEvent(ProxiedPlayer player, ServerInfo kickedFrom,
        BaseComponent[] kickReasonComponent, ServerInfo cancelServer, State state, Cause cause) {
        this.player = player;
